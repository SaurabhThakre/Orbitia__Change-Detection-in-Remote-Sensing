...
def getmymodelvegas():
    inputs = tf.keras.layers.Input((640, 640, 3))
    ...
    mvr = tf.keras.Model(inputs=[inputs], outputs=[outputs])
    mvr.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy'])
